package com.kot32.dynamicloadviewlibrary.reflect;
...
public class Reflect {
    ...
    private static Reflect on(Constructor<?> constructor, Object... args) throws ReflectException {
        try {
            return onObject(accessible(constructor).newInstance(args));
        } catch (Exception e) {
    ...
    private static Reflect on(Method method, Object object, Object... args) throws ReflectException {
        try {
            ...
            if (method.getReturnType() == void.class) {
                ...
                return onObject(method.invoke(object, args));
            }
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    ...
    public Reflect field(String name) throws ReflectException {
        try {
            Field field = field0(name);
            return onObject(field.get(object));
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    }
    ...
    public <P> P as(Class<P> proxyType) {
        ...
        final InvocationHandler handler = new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                try {
                    return onObject(object).call(name, args).get();
